          ...
          <div class="tab-pane">
            <div class="floor-1">
              <div class="blockgary">
                <ul class="jd-list">
                  <li
                      ...
                      :key="index">{{ keyword }}</li>
                </ul>
                <img src="../../../../public/images/floor-1-1.png" alt=""/>
              </div>
              <div class="floorBanner">
              <!-- 原来的 swiper-container -->
                <Carousel :locate="list.carouselList" />
              </div>
              <div class="split">
                <span class="floor-x-line"></span>
                <div class="floor-conver-pit">
                  <img src="../../../../public/images/floor-1-2.png" alt=""/>
                </div>
                <div class="floor-conver-pit">
              ...
              <div class="split center">
                <img src="../../../../public/images/floor-1-4.png" alt=""/>
              </div>
              <div class="split">
                <span class="floor-x-line"></span>
                <div class="floor-conver-pit">
                  <img src="../../../../public/images/floor-1-5.png" alt=""/>
                </div>
                <div class="floor-conver-pit">
                  <img src="../../../../public/images/floor-1-6.png" alt=""/>
                </div>
              </div>
            </div>
          </div>
